...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    //fixme kalshen 2017-10-10 增加
    private int mTabEnableFalseColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        //fixme kalshen 2017-10-10 增加
        mTabEnableFalseColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textEnableFalseColor, Color.parseColor("#95989A"));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                //fixme kalshen 2017-10-10 修改
                if (getTabs().get(i).isEnabled()) {
                    tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
                } else {
                    tab_title.setTextColor(mTabEnableFalseColor);
                }
    ...
    public int getTabEnableFalseColor() {
        return mTabEnableFalseColor;
    }

    public void setTabEnableFalseColor(int mTabEnableFalseColor) {
        this.mTabEnableFalseColor = mTabEnableFalseColor;
    }
    ...
    //fixme kalshen 2017-10-10 增加
    public List<RelativeLayout> getTabs(){
        ArrayList<RelativeLayout> tabs = new ArrayList<>();
        for (int i = 0; i < mTabCount; i++) {
            RelativeLayout tab = (RelativeLayout) mTabsContainer.getChildAt(i);
            tabs.add(tab);
        }
        return tabs;
    }
    ...
    //fixme kalshen 2017-10-10 增加
    public List<TextView> getTabTexts() {
        ArrayList<TextView> texts = new ArrayList<>();
        for (int i = 0; i < mTabCount; i++) {
            TextView tab = (TextView) mTabsContainer.getChildAt(i).findViewById(R.id.tv_tab_title);
            texts.add(tab);
        }
        return texts;
    }
